...
<input type="text" name="dname" value="Dr Srijan K.N" readonly style="position:absolute;top:93px;left:420px;background:none;font-size:20px;color:white;border:0px;"></input>

<input type="text" name="special1" value="Dermatologist" readonly style="position:absolute;top:146px;left:420px;background:none;font-size:20px;color:white;border:0px;"></input>
